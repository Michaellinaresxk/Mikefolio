    ...
    <div className="isolate px-6 py-24 sm:py-32 lg:px-8">
      ...
      <form action="#" method="POST" className="mx-auto mt-16 max-w-xl sm:mt-20">
        ...
        <div className="mt-10">
          <button
            type="submit"
            className="block w-full rounded-md bg-lightgreen px-3.5 py-2.5 text-center text-sm font-semibold text-black shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
          >
            Let's talk
          </button>
        </div>
